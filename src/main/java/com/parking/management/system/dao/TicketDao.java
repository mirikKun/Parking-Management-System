...
public class TicketDao implements Dao<Ticket> {
    ...
    private static final String GET_SPOT_BY_ID = "SELECT * FROM tickets WHERE id = ?";
    private static final String GET_ALL_SPOT = "SELECT * FROM tickets ORDER BY id";
    private static final String CREATE_SPOT_SQL = "INSERT INTO tickets VALUES (DEFAULT, ?, ?)";
    private static final String UPDATE_SPOT_SQL = "UPDATE tickets SET creation_date = ?, payment_id = ? WHERE id = ?";
    private static final String DELETE_SPOT_SQL = "DELETE FROM tickets WHERE id = ?";
